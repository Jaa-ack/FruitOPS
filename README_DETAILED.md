...
1. 查看地塊健康度與狀態
2. 點擊地塊查看詳細資訊與建議
3. 根據建議點擊「新增日誌」記錄農務作業
4. 需要具體建議時點擊「諮詢 AI」獲取即時指導
...
**早上（08:00-09:00）**：
1. 登入系統，查看「總覽」頁面今日決策建議
2. 檢查「訂單優先處理」，查看待處理訂單數量
3. 進入「智慧生產管理」，查看地塊健康度與今日建議農務
